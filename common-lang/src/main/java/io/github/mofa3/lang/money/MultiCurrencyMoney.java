...
public class MultiCurrencyMoney implements Serializable, Comparable<MultiCurrencyMoney>, Cloneable {
     ...
     * serialVersionUID
     */
    private static final long serialVersionUID = -1712688026509311867L;

    /**
     * 缺省的币种代码，为CNY（人民币）。
     */
    private static final String DEFAULT_CURRENCY_CODE = CurrencyEnum.CNY.getCurrencyCode();
     ...
     * @param cent 金额分数。
     */
    public MultiCurrencyMoney(long yuan, int cent) {
     ...
     * @param currency 币种
     */
    public MultiCurrencyMoney(long yuan, int cent, Currency currency) {
        this.setCurrency(currency);
        this.cent = CheckOverflow.longCheckedAdd(
                CheckOverflow.longCheckedMultiply(yuan, getCentFactor()), cent % getCentFactor());
     ...
     * @throws IllegalArgumentException 如果本货币对象与另一货币对象币种不同。
     */
    void addTo(MultiCurrencyMoney other) {
        assertSameCurrencyAs(other);
     ...
     * @throws IllegalArgumentException 如果本货币对象与另一货币对象币种不同。
     */
    void subtractFrom(MultiCurrencyMoney other) {
        assertSameCurrencyAs(other);
     ...
     * @return 乘法后的结果。
     */
    MultiCurrencyMoney multiply(long val) {
     ...
     * @throws IllegalArgumentException 如果本货币对象与另一货币对象币种不同。
     */
    private void assertSameCurrencyAs(MultiCurrencyMoney other) {
     ...
     */
    private MultiCurrencyMoney newMoneyWithSameCurrency(long cent) {
