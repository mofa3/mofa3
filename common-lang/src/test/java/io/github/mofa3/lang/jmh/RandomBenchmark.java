...
import io.github.mofa3.lang.util.UUIDGenerator;
...
//    }
    ...
    @Benchmark
    public void random() {
        RandomCodeUtil.generateTextCode(RandomCodeUtil.TYPE_NUM_LOWER, 16, null);
    }

    @Benchmark
    public void uuid() {
        UUIDGenerator.generatorToken();
    }

    public static void main(String[] args) throws RunnerException {
        Options options = new OptionsBuilder()
                .include(RandomBenchmark.class.getSimpleName())
                .output("/Users/mc/backupSpaces/mofa3/common-lang/target/RandomBenchmark.log")
                .build();
