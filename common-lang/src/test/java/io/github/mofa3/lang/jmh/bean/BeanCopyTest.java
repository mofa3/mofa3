 ...
 */
package io.github.mofa3.lang.jmh.bean;
...
import io.github.mofa3.lang.jmh.CmsUser;
import io.github.mofa3.lang.jmh.CmsUser1;
 ...
 *
 * @author ${baizhang}
 * @version $Id: BeanCopyTest.java, v 0.1 2019-02-19 2:30 PM Exp $
...
public class BeanCopyTest {
    ...
    @Benchmark
    public void apacheBeanUtil() throws InvocationTargetException, IllegalAccessException {
        CmsUser user = new CmsUser();
        user.setUserName("baizhang");
        user.setUserId(10000);
        user.setCreateTime(new Date());
...
//        org.apache.commons.beanutils.BeanUtils.copyProperties(user, user1);
    ...
    public static void main(String[] args) throws RunnerException {
        Options options = new OptionsBuilder()
                ...
                .output("/Users/mc/backupSpaces/mofa3/common-lang/target/BeanCopyTest.log")
                .build();
