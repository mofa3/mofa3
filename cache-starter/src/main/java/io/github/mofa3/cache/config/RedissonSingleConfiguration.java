...
@ConditionalOnExpression("'${cache.redis.model}'.equalsIgnoreCase('SINGLE')")
public class RedissonSingleConfiguration {
    private final RedisConfigProperties redisConfigProperties;

    public RedissonSingleConfiguration(ObjectProvider<RedisConfigProperties> redisConfigPropertiesProvider) {
